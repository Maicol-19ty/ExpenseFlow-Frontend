                      ...
                      <div className="flex items-center justify-between w-full">
                        <div className="flex items-center">
                          <a href="#" className="relative flex items-center space-x-3 rtl:space-x-reverse">
                            ...
                            <div
                                className="absolute left-[-18%] bottom-[-2px] bg-gradient-to-r from-transparent via-indigo-500 to-transparent h-[3px] w-[120%] blur-[1px] z-0"/>
                            <div
                                className="absolute left-[-18%] bottom-[-2px] bg-gradient-to-r from-transparent via-indigo-500 to-transparent h-[1px] w-[120%] z-0"/>
                            <div
                                className="absolute left-[8%] bottom-[-2px] bg-gradient-to-r from-transparent via-sky-500 to-transparent h-[3px] w-[70%] blur-[1px] z-0"/>
                            <div
                                className="absolute left-[8%] bottom-[-2px] bg-gradient-to-r from-transparent via-sky-500 to-transparent h-[1px] w-[70%] z-0"/>
                          </a>
                        </div>
                        <div
                            id="cross"
